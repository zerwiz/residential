        ...
        <nav className="flex items-center justify-between h-20 md:h-24">
          ...
          <div className="hidden md:flex items-center gap-10">
            {navLinks.map((link) => (
              <a
                key={link.label}
                href={link.href}
                className={`font-sans-custom text-[13px] font-light tracking-wide-editorial transition-colors duration-500 uppercase text-white hover:text-white/80`}
              >
                {link.label}
              </a>
            ))}
          ...
          >
            <motion.span
              ...
              className="block w-6 h-px transition-colors bg-white"
            />
            <motion.span
            ...
            <div className="max-w-lg">
              ...
              <div className="space-y-6">
                <p className="font-sans-custom text-[15px] font-light text-[#555555] leading-relaxed">
                  Every residence in our collection has been selected not merely for its
                  architectural merit, but for its capacity to transform the way you
                  experience daily life. These are spaces that transcend the ordinary,
                  where light, material, and landscape converge to create moments of
                  profound beauty.
                </p>
                <p className="font-sans-custom text-[15px] font-light text-[#555555] leading-relaxed">
                  We work intimately with visionary architects, discerning collectors,
                  and the world&apos;s most talented designers to present a portfolio that
                  represents the pinnacle of contemporary residential design. Each
                  property tells a story of ambition, craftsmanship, and an unwavering
        ...
        <AnimatedSection>
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="font-sans-custom text-[15px] font-light text-[#555555] leading-relaxed mb-10">
              Whether you are seeking the perfect residence or wish to list an extraordinary
              property, our team of specialists is here to guide you through every step of
              the process with discretion and care.
            </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <div className="flex flex-col gap-3">
              {["Residential", "Commercial", "New Developments", "Off-Market"].map(
                (link) => (
                  <a
                    key={link}
                    href="/properties"
